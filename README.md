...
If for some reason you want to add a marker interface to your services, you can specify this in the gradle build. The class specified 
will be in your own codebase, it  is not supplied by Protokruft. This could be useful if you want to scan your code for all 
GRPC service interfaces.

You'll end up with...

```kotlin
interface CarService : what.ever.iface.you.specify.InterfaceName {
 ...
}
```
...
```groovy
    ...
    protokruft {
        ...
        markerInterface = "com.mygreatpackage.GrpcService" // no marker by default
    }
